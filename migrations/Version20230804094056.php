 ...
 */
final class Version20230804094056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE log ADD context LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE log DROP context');
    }
}
